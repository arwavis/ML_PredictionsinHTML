...
data = pd.read_csv(
    "/Users/aravindv/Documents/Programming/Github/ML_PredictionsinHTML/Health_Prediction/survey lung cancer.csv")
...
X = data.drop('LUNG_CANCER', axis=1)  # independent features from the dataset
y = data['LUNG_CANCER']  # dependent column from the dataset
...
def l_reg_alg():
    ...
    if l_medical_details == 1:
        print(" The Prediction detected possibility of Lung Cancer")
    else:
        print(" You are completely fine, No sign of Lung related issues")
